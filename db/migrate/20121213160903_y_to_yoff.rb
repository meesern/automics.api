class YToYoff < ActiveRecord::Migration
  def self.up
    rename_column :placements, :x, :xoff
    add_column :placements, :yoff, :float
  ...
  def self.down
    rename_column :placements, :xoff, :x
    remove_column :placements, :yoff
